! Commands:
! 1. gfortran ca-currents.f v-currents.f eadca_sean.f -o eadca_sean
! 2. .\eadca_sean.exe
...
c	zxr=0.15d0 ! normal 
	...
	xmx=-2.0/250.0d0
c	xnai=xmx*rbcl+16.0 ! sodium concentraton.  pacing rate dependent due to Na accumulation.
	                   ! for 2D simulations and spiral waves just keep xnai constant.  

	xnai=xmx*520.0d0+16.0  ! we will hold the Na concentration constant.  
